...
import (
	...
	networkservicev1alpha1 "github.com/adodon2go/networkservicemesh/k8s/pkg/apis/networkservice/v1alpha1"
	...
	v1alpha1 "github.com/adodon2go/networkservicemesh/k8s/pkg/networkservice/listers/networkservice/v1alpha1"
)
